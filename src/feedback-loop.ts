...
import { mergeTemplateToRuleFromRules } from './templates.ts';
import { formatMethodology } from './methodology.ts';
 ...
 */
export function scoreAlignment<A extends string>(
  candidate: CrystallizationCandidate<A>,
  methodology: Methodology,
): number {
  if (methodology.principles.length === 0) return 0;
 ...
 */
export function buildGuidance(methodology: Methodology): string {
