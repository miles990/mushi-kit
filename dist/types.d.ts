...
export type MatchCondition = string | number | boolean | {
    lt?: number;
    lte?: number;
    gt?: number;
    gte?: number;
    ...
    includesAny: (string | number | boolean)[];
} | {
    includesAll: (string | number | boolean)[];
};
